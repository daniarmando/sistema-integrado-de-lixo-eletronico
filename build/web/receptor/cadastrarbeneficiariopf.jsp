...
<div id="content">
		<!--formulario cadastrar beneficiario pessoa fisica-->
         ${sucesso}</br></br>
          <div id="wrapper">
 				<h1>Cadastrar Beneficiário Pessoa Física</h1>
			</div>
                    
        <form id="formpattern" method="post" action="../CadastrarBeneficiario">
        	 <h2 align="center">Digite as informações do Beneficiário</h2><hr>
            		<input type="checkbox" class="input" name="tipobeneficiario" value="fisica" checked style="display:none"/>
	  	  <div class="field">
       			<label for="nome">Nome</label>
       				<span id="validationnome">
       				<input name="nomerazaobeneficiario" type="text" class="input" maxlength="80" />
		...
		<div class="field">
    			<label for="senha">Senha</label>
    				...
    				<input type="password" class="input" name="senhabeneficiario" maxlength="20"/>
