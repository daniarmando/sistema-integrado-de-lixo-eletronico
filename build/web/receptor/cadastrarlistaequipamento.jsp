<%-- 
    Document   : cadastrarlistaequipamento
    Created on : 11/06/2013, 19:23:35
    Author     : Daniel
--%>
...
<title>Cadastro de Equipamento na lista de Equipamentos - Siel - Sistema Integrado do E-Lixo</title>
...
<div id="content">
            ${sucesso}</br></br>
             <div id="wrapper">
 				<h1>Cadastrar lista de Equipamentos</h1>
			</div>

        <form id="formpattern" class="rounded" method="post" action="../CadastrarListaEquipamento">
			 <h2 align="center">Digite as informações do Equipamento</h3><hr>
        <div class="field">
       			<label for="nome">Nome</label>
       				<span id="validationnome">
       				<input name="nomelistaequipamento" type="text" class="input" maxlength="80" />
