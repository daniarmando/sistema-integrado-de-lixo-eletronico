<%-- 
    Document   : cadastrarlistapeca
    Created on : 21/06/2013, 21:30:45
    Author     : Daniel
--%>
...
<title>Cadastro de  Peça na lista de Peças- Siel - Sistema Integrado do E-Lixo</title>
...
<div id="content">
            ${sucesso}</br></br>
            <div id="wrapper">
 				<h1>Cadastrar Peça na lista de Peças</h1>
			</div>
            
             <%
                List <ListaEquipamento> listaequipamento = (List<ListaEquipamento>)request.getAttribute("listaequipamento");
                for (ListaEquipamento listaEquipamento : listaequipamento){
                %>

        <form id="formpattern" class="rounded" method="post" action="../CadastrarListaEquipamento">
  ...
  <tr class="linhas">
    <td><input type="text" name="nomelistapeca" style="text-align:center" /></td>
  ...
  <tr><td colspan="4">
        <a class="adicionarCampo" title="Adicionar item"><img src="images/plus.png" border="0" /></a>
                     ...
                     <input type="hidden" name="idlistaequipamento" value="<%= listaEquipamento.getIdListaEquipamento() %>"/>
