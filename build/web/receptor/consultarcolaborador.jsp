<%-- 
    Document   : consultarcolaborador
    Created on : 21/06/2013, 12:56:21
    Author     : Daniel
--%>
...
<title>Consultar Colaborador - Siel - Sistema Integrado do E-Lixo</title>
...
<div id="content">
    ...
    <form id="formpattern" method="POST" action="ConsultarColaborador">
        <input type="text" name="nomecolaborador" class="input"/>
    ...
    <tr>
        ...
        <td></td>
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td><%= colaborador.getIdColaborador() %></td>
                    <td><%= colaborador.getNomeColaborador() %></td>
                    <td><%= colaborador.getFuncaoColaborador() %></td>
                    <td><%= colaborador.getLoginColaborador() %></td>
                    <td><%= colaborador.getSenhaColaborador() %></td>
                    <td align="center"><a href="ExcluirColaborador?idColaborador=<%= colaborador.getIdColaborador()%>">Excluir</a></td>
                    <td align="center"><a href="CarregarColaborador?idColaborador=<%= colaborador.getIdColaborador()%>">Alterar</a></td>
                </tr>
                <%}%>
            </tbody>
        </table>
