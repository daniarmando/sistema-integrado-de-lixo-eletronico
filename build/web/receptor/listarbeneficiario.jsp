<%-- 
    Document   : listarbeneficiario
    Created on : 08/06/2013, 17:56:14
    Author     : Daniel
--%>
...
<title>Listar Beneficiário - Siel - Sistema Integrado do E-Lixo</title>
    ...
    <tr>
        ...
        <td></td>
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td><%= beneficiario.getIdPessoa() %></td>
