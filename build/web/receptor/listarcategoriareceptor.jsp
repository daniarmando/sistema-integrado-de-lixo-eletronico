<%-- 
    Document   : listarcategoriareceptor
    Created on : 22/06/2013, 20:53:19
    Author     : Daniel
--%>

<%@page import="br.com.projetosiel.model.CategoriaReceptor"%>
...
<title>Listar Categorias do Receptor - Siel - Sistema Integrado do E-Lixo</title>
...
<div id="content">
    ${sucesso}</br></br>
    <div id="wrapper">
 				<h1>Categorias de  <%= session.getAttribute("nome")%></h1>
			</div>
...
<table id="list" class="zebra">
    ...
    <tr>
        <th>ID</th>        
        <th>Nome</th>
        <th colspan="1" align="center">Editar</th>
    ...
    <tr>
        ...
        <td></td>
            ...
            <tbody>
                <%
                List <CategoriaReceptor> categoriasreceptor = (List<CategoriaReceptor>)request.getAttribute("categoriasreceptor");
                for (CategoriaReceptor categoriareceptor : categoriasreceptor){
                %>
                <tr>
                    <td><%= categoriareceptor.getIdCategoriaReceptor() %></td>
                    <td><%= categoriareceptor.getCategoria().getNomeCategoria() %></td>
                    <td align="center"><a href="ExcluirCategoria?idCategoriaReceptor=<%= categoriareceptor.getIdCategoriaReceptor() %>">Excluir</a></td>
                </tr>
                <%}%>
            </tbody>
        </table>
