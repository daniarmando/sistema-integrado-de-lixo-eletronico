<%-- 
    ...
    Created on : 22/06/2013, 17:04:05
    Author     : Daniel
--%>

<%@page import="br.com.projetosiel.model.Doacao"%>
...
<title>Listar Doação - Siel - Sistema Integrado do E-Lixo</title>
...
<table id="list" class="zebra">
    ...
    <tr>
        ...
        <td></td>
            ...
            <tbody>
                <%
                List <Doacao> doacoes = (List<Doacao>)request.getAttribute("doacoes");
                for (Doacao doacao : doacoes){
                %>
                <tr>
                    <td><%= doacao.getNumeroControleDoacao() %></td>
                    <td><%= doacao.getDescricaoDoacao() %></td>
                    <td><%= doacao.getStatusDoacao() %></td>
                    <td align="center"><a href="ExcluirDoacao?numeroControleDoacao=<%= doacao.getNumeroControleDoacao()%>">Excluir</a></td>
                    <td align="center"><a href="CarregarDoacao?numeroControleDoacao=<%= doacao.getNumeroControleDoacao()%>">Alterar</a></td>
                </tr>
                <%}%>
            </tbody>
        </table>
