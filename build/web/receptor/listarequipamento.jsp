<%-- 
    Document   : listarequipamento
    Created on : 22/06/2013, 18:58:07
    Author     : Daniel
--%>

<%@page import="br.com.projetosiel.model.Equipamento"%>
...
<title>Listar Equipamento - Siel - Sistema Integrado do E-Lixo</title>
        ...
        <td></td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= equipamento.getStatusEquipamento() %></td>
                    <td><%= equipamento.getEstadoEquipamento() %></td>
                    
                   
                    <td align="center"><a href="ExcluirEquipamento?codigoEquipamento=<%= equipamento.getCodigoEquipamento()%>">Excluir</a></td>
                    <td align="center"><a href="CarregarEquipamento?codigoEquipamento=<%= equipamento.getCodigoEquipamento()%>">Alterar</a></td>
                </tr>
                <%}%>
            </tbody>
        </table>
