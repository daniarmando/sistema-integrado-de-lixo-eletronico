<%-- 
    Document   : listarlistapeca
    Created on : 23/06/2013, 16:55:05
    Author     : Daniel
--%>
...
<html>
    <head>
        ...
        <title>Lista de peças - Siel - Sistema Integrado do E-Lixo</title>
    ...
    <tr>
        ...
        <td></td>
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td><%= listaPeca.getIdListaPeca() %></td>
                    <td><%= listaPeca.getNomeListaPeca() %></td>
                    <td align="center"><a href="ExcluirListaPeca?idListaPeca=<%= listaPeca.getIdListaPeca()%>">Excluir</a></td>
                    <td align="center"><a href="CarregarListaPeca?idListaPeca=<%= listaPeca.getIdListaPeca() %>">Alterar</a></td>
                </tr>
                <%}%>
            </tbody>
        </table>
