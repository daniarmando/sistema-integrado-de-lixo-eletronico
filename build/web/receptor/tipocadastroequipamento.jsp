<%-- 
    Document   : tipocadastroequipamento
    Created on : 23/06/2013, 19:06:23
    Author     : Daniel
--%>
...
<div id="content">
        ...
        <!--formulario chama os formularios de cadastro-->
         <form id="formpattern" class="rounded">
          	<h2 align="center">Selecione o Tipo de Cadastro</h2><hr>
        	<select name="tipopessoa" class="select" onchange="javascript: abreJanela(this.value)">
            	<option value="" selected="selected">Tipo de Cadastro</option>
            	<option value="../DadosEquipamento?tipo=A">Pela lista de equipamentos</option>
                <option value="../DadosEquipamento?tipo=M">Manualmente</option>
            </select>
		</form>
</div>
<!--fim da conteudo-->     
