 ...
 * @author Daniel
 */
public class CancelarColeta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           request.getRequestDispatcher("ListarStatusColeta?status=cancelado").forward(request, response);
        } catch (Exception ex){
