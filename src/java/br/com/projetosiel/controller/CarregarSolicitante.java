 ...
 * @author Daniel
 */
public class CarregarSolicitante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String tipoPessoa = request.getParameter("tipoPessoa");
         try {
            ...
            request.setAttribute("solicitante", dao.carregar(idSolicitante));
            if(tipoPessoa.equals("fisica")){
                
            
            request.getRequestDispatcher("alterarsolicitantepf.jsp").forward(request, response);
            }else{
              request.getRequestDispatcher("alterarsolicitantepj.jsp").forward(request, response);  
            }
        } catch (Exception ex) {
