 ...
 * @author Daniel
 */
public class ConfirmarColeta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       coleta.setStatusColeta(statusColeta);
        ...
        try {
           ...
           request.getRequestDispatcher("ListarStatusColeta?status=andamento").forward(request, response);
        } catch (Exception ex){
