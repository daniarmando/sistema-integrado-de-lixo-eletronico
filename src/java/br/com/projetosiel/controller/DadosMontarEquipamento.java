 ...
 * @author Daniel
 */
public class DadosMontarEquipamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         try{
            ...
            request.setAttribute("pecas", daoPeca.listar());
            
            request.getRequestDispatcher("receptor/montarequipamento.jsp").forward(request, response);
           
        } catch (Exception ex){
            System.out.println("Problemas no Servlet ao carregar os dados do MontarEquipamento! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
