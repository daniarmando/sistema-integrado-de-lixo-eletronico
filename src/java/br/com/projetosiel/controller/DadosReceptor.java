 ...
 * @author Daniel
 */
public class DadosReceptor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (tipo.equals("PJ")){
                request.getRequestDispatcher("cadastrarreceptorpj.jsp").forward(request, response);
            } else if (tipo.equals("PF")){
                request.getRequestDispatcher("cadastrarreceptorpf.jsp").forward(request, response);
            }
            
        } catch (Exception ex){
            System.out.println("Problemas no Servlet ao carregar os dados do receptor! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
