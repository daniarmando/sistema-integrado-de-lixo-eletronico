 ...
 * @author Daniel
 */
public class ExcluirPontoColeta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       Integer idPontoColeta = Integer.parseInt(request.getParameter("idPontoColeta"));
        ...
        try {
            ...
            dao.excluir(idPontoColeta);
            
            request.getRequestDispatcher("ListarPontoColeta").forward(request, response); 
        }catch (Exception ex){
            System.out.println("Problemas no servlet ao excluir PontoColeta! Erro: "+ex.getMessage());
            ex.printStackTrace();
        }
    }
