...
public class ListarCategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           request.getRequestDispatcher("receptor/listarcategoria.jsp").forward(request, response);
        }catch (Exception ex){
            System.out.println("Problemas no servlet ao listar Categorias! Erro:"+ex.getMessage());
            ex.printStackTrace();
        }
    }
