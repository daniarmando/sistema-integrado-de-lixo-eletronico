...
public class ListarDoacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           request.getRequestDispatcher("receptor/listardoacao.jsp").forward(request, response);
        }catch (Exception ex){
            System.out.println("Problemas no servlet ao listar Doações! Erro:"+ex.getMessage());
            ex.printStackTrace();
        }
    }
