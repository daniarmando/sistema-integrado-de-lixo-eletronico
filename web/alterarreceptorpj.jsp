<%-- 
    Document   : alterarreceptorpj
    Created on : 15/06/2013, 10:08:49
    Author     : Daniel
--%>
...
<div id="content">
        ...
        <form id="formpattern" class="rounded" method="post" action="AlterarReceptor">
         ...
         <div class="field">
         		<label for="razao">Razão</label>
                    ...
                    <input type="text" class="input" name="nomerazaosolicitante"  value="${receptor.nomeRazaoPessoa}"/>
         ...
         <div class="field">
         		<label for="cnpj">CNPJ</label>
                	...
                	<input type="text" class="input" name="cpfcnpjsolicitante"  value="${receptor.cpfCnpjPessoa}"/>
         ...
         <div class="field">
         		<label for="ie">I.E.</label>
                	...
                	<input type="text" class="input" name="rgiesolicitante"  value="${receptor.rgIePessoa}"/>
		  ...
		  <label for="tel">Telefone</label>
    				...
    				<input type="text" class="input" name="telefonesolicitante" placeholder="(00) 0000-0000" value="${receptor.telefonePessoa}"/>
			...
			<div class="field">
    			<label for="rua">Rua</label>
    				...
    				<input type="text" class="input" name="ruasolicitante" maxlength="80" value="${receptor.ruaPessoa}"/>
    				<span class="textfieldRequiredMsg">Digite a rua.</span></span>
			</div>
            <div class="field">
    			<label for="numero">Número</label>
			  		<span id="validationnumero">
    				<input type="text" class="input" name="numerosolicitante" maxlength="10" value="${receptor.numeroPessoa}"/>
			...
			<div class="field">
    			<label for="bairro">Bairro</label>
    				...
    				<input type="text" class="input" name="bairrosolicitante" maxlength="80" value="${receptor.bairroPessoa}" />
    				<span class="textfieldRequiredMsg">Digite o bairro.</span></span>
			</div>
			<div class="field">
    			<label for="complemento">Complemento</label>
		   		  	<span id="validationcomplemento">
    				<input type="text" class="input" name="complementosolicitante" maxlength="100" value="${receptor.complementoPessoa}"/>
					</span>
			...
			<div class="field">
    			<label for="cidade">Cidade</label>
    				...
    				<input type="text" class="input" name="cidadesolicitante" maxlength="80" value="${receptor.cidadePessoa}"/>
			...
			<div class="field">
    			<label for="cep">CEP</label>
    				...
    				<input type="text" class="input" name="cepsolicitante" value="${receptor.cepPessoa}" />
        ...
        <div class="field">
		 	 	<label for="email">Email</label>
          			...
          			<input type="text" class="input" name="emailsolicitante" maxlength="30" placeholder="exemplo@exemplo.com.br" value="${receptor.emailPessoa}" />
		...
		<div class="field">
    			<label for="login">Login</label>
    				...
    				<input type="text" class="input" name="loginsolicitante" maxlength="20" value="${receptor.loginPessoa}"/>
    				<span class="textfieldRequiredMsg">Digite o login</span></span>
		</div>
		<div class="field">
    			<label for="senha">Senha</label>
		  			<span id="validationsenha">    				
                    <input type="password" class="input" name="senhasolicitante" maxlength="" value="${receptor.senhaPessoa}"/>
