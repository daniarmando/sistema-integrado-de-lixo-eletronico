<%-- 
    Document   : alterarsolicitante
    Created on : 14/06/2013, 22:09:00
    Author     : Daniel
--%>
...
<div id="content">
        ...
        <form id="formpattern" method="post" action="AlterarSolicitante">
	  	  ...
	  	  <div class="field">
       			...
       			<label for="nome">Nome</label>
       				...
       				<input name="nomerazaosolicitante" type="text" class="input" maxlength="80" value="${solicitante.nomeRazaoPessoa}"/>
         	...
         	<div class="field">
          	...
          	<div class="field">
         		<label for="rg">RG</label>
                	...
                	<input type="text" class="input" name="rgiereceptor" value="${solicitante.rgIePessoa}" />
		...
		<div class="field">
    			<label for="senha">Senha</label>
    				...
    				<input type="password" class="input" name="senhasolicitante" maxlength="20" value="${solicitante.senhaPessoa}"/>
