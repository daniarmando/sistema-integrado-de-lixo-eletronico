...
<div id="content">
        ...
        <form id="formpattern" class="rounded" method="post" action="CadastrarReceptor">
			 <h2 align="center">Digite as informações do Receptor</h3><hr>
             		<input type="checkbox" class="input" name="tiporeceptor" value="juridica" checked style="display:none"/>
         <div class="field">
         		<label for="razao">Razão</label>
   		   			<span id="validationrazao">
                    <input type="text" class="input" name="nomerazaoreceptor"  />
		...
		<div class="field">
    			<label for="senha">Senha</label>
                    ...
                    <input type="password" class="input" name="senhareceptor" maxlength="" />
