...
<div id="content">
        ...
        <!--formulario chama os formularios de cadastro-->
         <form id="formpattern" class="rounded">
          	<h2>Cadastro de Solicitante</h3>
          		<h4>Favor informar o tipo de Solicitante</h4>
        	<select name="tipopessoa" class="select" onchange="javascript: abreJanela(this.value)">
            	...
            	<option value="cadastrarsolicitantepf.jsp">Física - CPF</option>
                <option value="cadastrarsolicitantepj.jsp">Jurídica - CNPJ</option>
            </select>
		</form>
</div>
