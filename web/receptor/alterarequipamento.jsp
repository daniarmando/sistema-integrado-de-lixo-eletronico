<%-- 
    Document   : alterarequipamento
    Created on : 22/06/2013, 19:27:34
    Author     : Daniel
--%>
...
<title>Alterar Equipamento - Siel - Sistema Integrado do E-Lixo</title>
...
<div id="content">
        ...
        <form id="formpattern" class="rounded" method="post" action="AlterarEquipamento">
			 <h2 align="center">Digite as informações Equipamento</h3><hr>
                         
                          <div class="field">
       			<label for="nome">Código</label>
       				<span id="validationnome">
                                   <input type="text" name="codigoequipamento" readonly size="2" value="${equipamento.codigoEquipamento}" />
        ...
        <div class="field">
       			<label for="nome">Nome</label>
       				<span id="validationnome">
                                    <input name="nomeequipamento" type="text" class="input" maxlength="80" value="${equipamento.nomeEquipamento}" />
       				<span class="textfieldRequiredMsg">Digite o Nome.</span></span>
                    </div>
