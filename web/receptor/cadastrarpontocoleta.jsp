<%-- 
    Document   : cadastrarpontocoletapf
    Created on : 23/05/2013, 19:28:41
    Author     : Daniel
--%>
...
<html>
    <head>
        ...
        <title>Cadastro de Ponto de Coleta - Siel - Sistema Integrado do E-Lixo</title>
    ...
    <body>
        ...
        <div id="content">
            ...
            <form id="formpattern" method="post" action="../CadastrarPontoColeta">
              <h2 align="center">Digite as informações do Ponto de Coleta</h2><hr>

                    <div class="field">
                        <label for="nome">Nome</label>
                        <span id="validationnome">
                            <input name="nomepontocoleta" type="text" class="input" maxlength="80" />
                            <span class="textfieldRequiredMsg">Digite o Nome.</span></span></div>

                    <div class="field">
                        <label for="tel">Telefone</label>
                        <span id="validationtel">
                            <input type="text" class="input" name="telefonepontocoleta" palaceholder="(00) 0000-0000"/>
                    ...
                    <div class="field">
                        ...
                        <span id="validationcidade">
                            <input type="text" class="input" name="cidadepontocoleta" maxlength="80" />
                    ...
                    <div class="field">
                        ...
                        <span id="validationcep">
                            <input type="text" class="input" name="ceppontocoleta" />
