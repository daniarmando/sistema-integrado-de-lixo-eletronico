<%-- 
    Document   : cadastrartipoatendimento
    Created on : 04/06/2013, 20:10:56
    Author     : Daniel
--%>
...
<title>Cadastro de Tipo Coleta - Siel - Sistema Integrado do E-Lixo</title>
...
<div id="content">
        ...
        ${sucesso}</br></br>
            <div id="wrapper">
 				<h1>Cadastrar Tipo de Coleta</h1>
			</div>
                    
        <form id="formpattern" method="post" action="../CadastrarTipoColeta">
        	 <h2 align="center">Digite as informações do Tipo Coleta</h3><hr>
               
		  	<div class="field">
		  <label for="tipoatendimento">Tipo de Atendimento nas Coletas</label>
		  
          <input type="radio" name="nometipocoleta" class="radio" value="recebe"/>Recebe Equipamentos<br />
          <input type="radio" name="nometipocoleta" class="radio" value="busca"/>Busca Equipamentos<br />
          <input type="radio" name="nometipocoleta" class="radio" value="recebe e busca"/>Recebe e Busca Equipametos<br />
          </div>
