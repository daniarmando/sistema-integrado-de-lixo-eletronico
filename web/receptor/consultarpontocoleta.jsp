<%-- 
    Document   : consultarpontocoleta
    Created on : 21/06/2013, 12:57:37
    Author     : Daniel
--%>
...
<html>
    <head>
        ...
        <title>Consultar Ponto de Coleta - Siel - Sistema Integrado do E-Lixo</title>
...
<div id="content">
    ...
    <form id="formpattern" method="POST" action="ConsultarPontoColeta">
        <input type="text" name="nomepontocoleta" class="input" />
    ...
    <div id="tablelist">
		<table id="list" class="zebra">
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td><%= pontoColeta.getIdPontoColeta() %></td>
                    <td><%= pontoColeta.getNomePontoColeta() %></td>
                    <td><%= pontoColeta.getTelefonePontoColeta() %></td>
                    <td><%= pontoColeta.getRuaPontoColeta() %></td>
                    <td><%= pontoColeta.getNumeroPontoColeta() %></td>
                    <td><%= pontoColeta.getComplementoPontoColeta() %></td>
                    <td><%= pontoColeta.getBairroPontoColeta() %></td>
                    <td><%= pontoColeta.getCidadePontoColeta() %></td>
                    <td><%= pontoColeta.getEstadoPontoColeta() %></td>
                    <td><%= pontoColeta.getCepPontoColeta() %></td>
                    <td align="center"><a href="ExcluirPontoColeta?idPontoColeta=<%= pontoColeta.getIdPontoColeta()%>">Excluir</a></td>
                    <td align="center"><a href="CarregarPontoColeta?idPontoColeta=<%= pontoColeta.getIdPontoColeta()%>">Alterar</a></td>
                </tr>
                <%}%>
            </tbody>
        </table>
