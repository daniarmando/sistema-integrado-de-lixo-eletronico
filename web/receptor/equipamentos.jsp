<%-- 
    ...
    Created on : 24/06/2013, 20:43:02
    Author     : Daniel
--%>
...
<title>Equipamentos - Siel - Sistema Integrado do E-Lixo</title>
...
<div id="content">
        ...
        <!--formulario chama os formularios de cadastro-->
         <form id="formpattern" class="rounded">
          		...
          		<h4>Selecione onde deseja ir</h4>
        	<select name="statuscoleta" class="select" onchange="javascript: abreJanela(this.value)">
            	<option value="" selected="selected">Equipamentos</option>
                <option value="../ListarStatusMaterialColeta?statusMaterialColeta=ncadastrado">Equipamentos a serem cadastrados</option>
                <option value="../ListarEquipamento">Consultar Equipamento</option>
