<%-- 
    Document   : listarcoletas_cadequipamento
    Created on : 25/06/2013, 12:54:49
    Author     : Daniel
--%>
...
<title>Listar Coletas concluídas - Siel - Sistema Integrado do E-Lixo</title>
...
<div id="content">
    ${sucesso}</br></br>
    <div id="wrapper">
 	<h1>Equipamentos a serem cadastrados</h1>
	</div>
...
<table id="list" class="zebra">
    ...
    <tr>
        ...
        <th colspan="2" align="center"><center>Ação</center></th>
        ...
        <td></td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%= coleta.getNomeSolicitanteColeta() %></td>
                     
                    
                    <td align="center"><a href="CarregarColeta?numeroControleColeta=<%= coleta.getNumeroControleColeta() %>">Cadastrar</a></td>
                </tr>
                <%}%>
            </tbody>
        </table>
