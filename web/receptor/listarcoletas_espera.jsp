<%-- 
    Document   : coletas_espera
    Created on : 24/06/2013, 19:11:00
    Author     : Daniel
--%>
...
<title>Listar Coletas em espera - Siel - Sistema Integrado do E-Lixo</title>
        ...
        <td></td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center"><a href="ConfirmarColeta?numeroControleColeta=<%= coleta.getNumeroControleColeta() %>">Confirmar</a></td>
