<%-- 
    Document   : listarpeca
    Created on : 22/06/2013, 21:21:59
    Author     : Daniel
--%>
...
<title>Listar Peças - Siel - Sistema Integrado do E-Lixo</title>
    ...
    <tr>
        ...
        <td></td>
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td><%= peca.getCodigoPeca() %></td>
                    <td><%= peca.getNomePeca() %></td>
                    <td><%= peca.getDetalhePeca() %></td>
                   
                    <td align="center"><a href="ExcluirPeca?codigoPeca=<%= peca.getCodigoPeca()%>">Excluir</a></td>
                    <td align="center"><a href="CarregarPeca?codigoPeca=<%= peca.getCodigoPeca() %>">Alterar</a></td>
                </tr>
                <%}%>
            </tbody>
        </table>
