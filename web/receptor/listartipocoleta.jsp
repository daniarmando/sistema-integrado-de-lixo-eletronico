<%-- 
    Document   : lsitartipocoleta
    Created on : 20/06/2013, 19:38:27
    Author     : Daniel
--%>
...
<title>Listar Tipo Coleta - Siel - Sistema Integrado do E-Lixo</title>
...
<table id="list" class="zebra">
    ...
    <tr>
        ...
        <td></td>
            ...
            <tbody>
                <%
                List <TipoColeta> tipocoletas = (List<TipoColeta>)request.getAttribute("tipocoletas");
                for (TipoColeta tipocoleta : tipocoletas){
                %>
                <tr>
                    <td><%= tipocoleta.getIdTipoColeta() %></td>
                    <td><%= tipocoleta.getNomeTipoColeta() %></td>
                    <td align="center"><a href="ExcluirTipoColeta?idTipoColeta=<%= tipocoleta.getIdTipoColeta()%>">Excluir</a></td>
                    <td align="center"><a href="CarregarTipoColeta?idTipoColeta=<%= tipocoleta.getIdTipoColeta()%>">Alterar</a></td>
                </tr>
                <%}%>
            </tbody>
        </table>
